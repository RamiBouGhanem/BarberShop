...
function Contact() {
  return (
    <div className="contact-container p-6 shadow-md w-full bg-black px-6 sm:px-14">
      <div className="contact-info flex flex-col lg:flex-row justify-between pt-12 pb-24 pr-16 pl-8 text-center">
        ...
        <div className="contact-details mb-8 lg:mb-0 pr-12">
          ...
          <p className="flex items-center text-gray-200 text-xl lg:text-2xl p-1">
            <a href="mailto:rami.boughanem240@gmail.com" className="text-blue-500 hover:underline mx-auto">rami.boughanem240@gmail.com</a>
          </p>
        </div>
